...
void  read_auth    ( PlayerConnection *d );
void  send_auth    ( PlayerConnection *d );
...
void  start_auth( PlayerConnection *d )
{
	...
	tlen = sizeof( sock );
	getpeername( d->GetDescriptor(), ( struct sockaddr * )&sock, &tlen );
...
void  send_auth( PlayerConnection *d )
{
    ...
    if ( getsockname( d->GetDescriptor(), ( struct sockaddr *)&us, &ulen )
    ||   getpeername( d->GetDescriptor(), ( struct sockaddr *)&them, &tlen ) )
    {
